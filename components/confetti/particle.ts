import { degreesToRads, randomInt, randomRange } from "./utils.ts";
import { IConfettiOptions } from "./confetti.ts";
...
export default class Particle {
  ...
  update() {
    ...
    this.vy *= friction;
    if (
      this.rotateY >= 1 && this.rotationDirection === RotationDirection.Positive
    ) {
